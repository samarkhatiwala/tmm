...
/* IK: RMSE for dissolved Fe */

ISEXTERN Vec mbgc8avg; /* The individual model equivalents/misfits */
ISEXTERN Vec obgc8; /* The observation arrays */
ISEXTERN Vec cbgc8; /* The individual cost functions (e.g., RMS) */
ISEXTERN Vec wbgc8; /* misfit weights for each individual box and tracer type*/
ISEXTERN Vec w8; /* array to store overall weight in */
ISEXTERN PetscScalar VolSum8; /* global fractional volumes for computation of average */
ISEXTERN PetscScalar NoSum8; /* global fractional volumes for computation of average */
ISEXTERN PetscScalar Gaveobgc8; /* global average observed DFe */
ISEXTERN PetscScalar Gavembgc8; /* global average simulated DFe */
ISEXTERN PetscScalar Gavecost8;  /* global cost function for DFe */
ISEXTERN PetscScalar RGavecost8;  /* square root of global cost function for DFe */
ISEXTERN PetscScalar GDFecost;  /* global overall cost function, to be thrown at optimizer */
